...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.query_index_page = QtWidgets.QWidget(self.centralwidget)
        ...
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.query_index_page)
        self.verticalLayout_2.setContentsMargins(100, 200, 100, 200)
        ...
        self.verticalLayout.addWidget(self.query_is_hq, 0, QtCore.Qt.AlignRight)
        ...
        self.verticalLayout.addWidget(self.input_item_name)
        ...
        self.verticalLayout.addWidget(self.query_button, 0, QtCore.Qt.AlignRight)
        self.verticalLayout_2.addLayout(self.verticalLayout)
        self.gridLayout.addWidget(self.query_index_page, 1, 0, 1, 1)
        ...
        self.action1.triggered['bool'].connect(self.query_index_page.setHidden) # type: ignore
        QtCore.QMetaObject.connectSlotsByName(mainWindow)

    def retranslateUi(self, mainWindow):
        _translate = QtCore.QCoreApplication.translate
        mainWindow.setWindowTitle(_translate("mainWindow", "猴面雀 - FF14市场查询工具"))
        self.query_is_hq.setText(_translate("mainWindow", "查询HQ"))
        self.input_item_name.setPlaceholderText(_translate("mainWindow", "请输入要查询的物品名称"))
        ...
        self.select_server_hongyuhai.setProperty("query_server", _translate("mainWindow", "红玉海"))
        self.select_server_shenyizhidi.setText(_translate("mainWindow", "神意之地"))
        self.select_server_shenyizhidi.setProperty("query_server", _translate("mainWindow", "神意之地"))
        self.select_server_lanuoxiya.setText(_translate("mainWindow", "拉诺西亚"))
        self.select_server_lanuoxiya.setProperty("query_server", _translate("mainWindow", "拉诺西亚"))
        self.select_server_huanyignqundao.setText(_translate("mainWindow", "幻影群岛"))
        self.select_server_huanyignqundao.setProperty("query_server", _translate("mainWindow", "幻影群岛"))
        self.select_server_mengyachi.setText(_translate("mainWindow", "萌芽池"))
        self.select_server_mengyachi.setProperty("query_server", _translate("mainWindow", "萌芽池"))
